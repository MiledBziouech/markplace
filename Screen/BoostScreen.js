...
import { View, ScrollView,StyleSheet, Image, Text,SafeAreaView } from 'react-native';
import FontAwesomeIcon from 'react-native-vector-icons/FontAwesome';
import { faHeart } from '@fortawesome/free-regular-svg-icons';

const BoostScreen = () => {
  console.log('booster is rendered');
  return (
    <SafeAreaView style ={styles.container}>
      ...
      <View style={{flexDirection:'row',justifyContent: 'center',}} >
      <View style={styles.frame}>
        <Image source={require('../assets/boost5.png')} style={styles.image} />
        <View style={styles.overlay}>
          <FontAwesomeIcon icon={faHeart} size={24} color='white' />
        </View>
        <Text style={styles.price}>$10</Text>
      ...
      <View style={styles.frame}>
        <Image source={require('../assets/boost6.png')} style={styles.image} />
        <View style={styles.overlay}>
          <FontAwesomeIcon icon={faHeart} size={24} color='white' />
        </View>
        <Text style={styles.price}>$10</Text>
