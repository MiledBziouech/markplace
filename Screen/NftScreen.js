...
const NftScreen = () => {
  ...
  return (
    <SafeAreaView style ={styles.container}>
      ...
      <View style={{flexDirection:'row',justifyContent: 'center',}} >
      <View style={styles.frame}>
        <Image source={require('../assets/bycycle5.png')} style={styles.image} />
        <View style={styles.overlay}>
          <FontAwesomeIcon icon={faHeart} size={24} color='white' />
        </View>
        <Text style={styles.price}>$10</Text>
      ...
      <View style={styles.frame}>
        <Image source={require('../assets/bycycle6.png')} style={styles.image} />
        <View style={styles.overlay}>
          <FontAwesomeIcon icon={faHeart} size={24} color='white' />
        </View>
        <Text style={styles.price}>$10</Text>
      ...
      <View style={{flexDirection:'row',justifyContent: 'center',}} >
      <View style={styles.frame}>
        <Image source={require('../assets/bycycle7.png')} style={styles.image} />
        <View style={styles.overlay}>
          <FontAwesomeIcon icon={faHeart} size={24} color='white' />
        </View>
        <Text style={styles.price}>$10</Text>
      ...
      <View style={styles.frame}>
        <Image source={require('../assets/bycycle8.png')} style={styles.image} />
        <View style={styles.overlay}>
          <FontAwesomeIcon icon={faHeart} size={24} color='white' />
        </View>
        <Text style={styles.price}>$10</Text>
